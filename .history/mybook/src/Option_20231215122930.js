...
var Option = (x) => {
    ...
    return (
    <div class="mt-4 ml-4  grid gap-6 h-full overflow-scroll  overflow-y-scroll">
    ...
    <i class="fa-solid fa-chevron-down text-blue-500 "></i>
        ...
        <button class="font-semibold text-xl text-slate-700" onclick={sayHello}>Xem thêm</button>

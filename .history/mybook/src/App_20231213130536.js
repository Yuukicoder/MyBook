...
var Navbar = () =>(
    ...
    <div class="flex items-center justify-between  w-screen py-3 px-3  bg-cyan-500 shadow-lg shadow-slate-100">
        <div class="flex">

    <div class="Navbar_icon pr-3">
        <img class="w-10 h-10" src='iconMyBook.png' alt=""></img> 
    </div>
    <div class="Navbar_search h-10 bg-white rounded-3xl">
        <label class=" text-center h-full pl-6"for="">
    <i class="fa-solid fa-magnifying-glass text-gray-400" ></i>
        </label>

        <input class="rounded-3xl text-center h-full pr-6" type="text" placeholder="Tìm kiếm trên MyBook"></input>
        </div>

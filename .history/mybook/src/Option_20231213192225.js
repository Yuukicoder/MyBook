...
var ButtonCollapse = () =>{
   ...
   return collapse.style.color='red';
}
...
var Option = (x) => (
    ...
    <i class="fa-solid fa-chevron-down text-red-500 "></i>
        </div>
        <p  id="Collapse"class="font-semibold text-xl text-slate-700"  onclick={ButtonCollapse}>Xem thêm</p>

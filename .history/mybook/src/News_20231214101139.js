var Story_Page = (x) => (
    <div class=" w-48 h-80  rounded-2xl bg-green-600 relative">
        <div class="avatar absolute right-0 left-0 top-0">
            <img class=" h-full w-full rounded-full" 
            src={x.avatar||"https://news.khangz.com/wp-content/uploads/2018/10/che-do-an-danh-chrome-1.png"} alt=""></img>
            </div>
            <div class="story">
                <img class="h-full object-cover w-full object-cover overflow-hidden" src={x.story} alt=""></img>
            </div>
            <div class="author absolute right-0 bottom-0 left-0">{x.author||"Ẩn danh"}</div>
    </div>
    )
var News = () =>(
    <div class="grid">
